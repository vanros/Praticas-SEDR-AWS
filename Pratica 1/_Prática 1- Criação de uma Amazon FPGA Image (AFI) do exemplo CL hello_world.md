...
```bash 
aws ec2 create-fpga-image --region us-east-1 --name afi-teste-pratica1 --description afi-para-testar-pratica1 --input-storage-location Bucket=teste-pratica1,Key=teste-pratica1-folder/18_04_19-175625.Developer_CL.tar --logs-storage-location Bucket=teste-pratica1,Key=teste-pratica1-log-folder/LOGS_FILES_GO_HERE.txt --client-token teste 
```
